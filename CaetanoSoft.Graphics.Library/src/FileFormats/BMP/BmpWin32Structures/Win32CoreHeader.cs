...
namespace CaetanoSoft.Graphics.FileFormats.BMP.Win32Structures
{
    ...
    /// </summary>
    /// <remarks>
    /// Make shore that <c>sizeof(Win32CoreHeader)</c> returns the size of 12 bytes and is byte aligned.
    ...
    internal struct Win32CoreHeader
    {
        ...
        /// <para>If <c>Win32CoreHeader.BitsPerPixel</c> is 2, the bitmap is Windows CE 2.0 and above specific.</para>
        /// <see cref="WinRgbTriple"/> structure vector (most important colors at top), up to the maximum palette size dictated by the bpp.
        /// </summary>
        /// <remarks>
        /// The color table (if present) must follow the <c>Win32CoreHeader</c> structure, and consist of
        /// </remarks>
