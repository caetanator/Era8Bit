...
namespace CaetanoSoft.Graphics.FileFormats.BMP.Win32Structures
{
    ...
    /// </summary>
    /// <remarks>
    /// Make shore that <c>sizeof(Win32InfoHeaderV5)</c> returns the size of 124 bytes and is byte aligned.
    ...
    internal struct Win32InfoHeaderV5
    {
        ...
        /// <remarks>
        /// On Windows 98, Windows 2000 and above: If <c>Win32InfoHeaderV5.Compression</c> is <c>BmpCompression.JPEG</c> or <c>BmpCompression.PNG</c>,
        /// the <c>Win32InfoHeaderV5.Width</c> member specifies the width of the decompressed JPEG or PNG image file, respectively.
        /// </remarks>
        /// </summary>
        public int Width;
        ...
        /// <para>If <c>Win32InfoHeaderV5.Height</c> is positive, the bitmap is a bottom-up DIB and its origin is the lower-left corner.</para>
        /// <para>If <c>Win32InfoHeaderV5.Height</c> is negative, the bitmap is a top-down DIB and its origin is the upper-left corner.</para>
        /// <para>Top-down DIBs cannot be compressed: <c>Win32InfoHeaderV5.Compression</c> must be either <c>BmpCompression.RGB</c>,
        /// <c>BmpCompression.BitFields</c> or <c>BmpCompression.AlphaBitFields</c>.</para>
        /// <remarks>
        /// On Windows 98, Windows 2000 and above: If <c>Win32InfoHeaderV5.Compression</c> is <c>BmpCompression.JPEG</c> or <c>BmpCompression.PNG</c>,
        /// the <c>Win32InfoHeaderV5.Height</c> member specifies the height of the decompressed JPEG or PNG image file, respectively.
        /// </remarks>
        /// </summary>
        public int Height;
        ...
        /// <para>If <c>Win32InfoHeaderV5.BitsPerPixel</c> is 0, <c>Win32InfoHeaderV5.Compression</c> must be either <c>BmpCompression.JPEG</c> or
        /// <c>BmpCompression.PNG</c>.</para>
        /// <para>If <c>Win32InfoHeaderV5.BitsPerPixel</c> is 2, the bitmap is Windows CE 1.0 and above specific.</para>
        /// <see cref="Compression"/>
        /// </summary>
        /// <remarks>
        /// The color table (if present) must follow the <c>Win32InfoHeaderV5</c> structure, and consist of
        ...
        /// <para>
        /// If this value is 0, the bitmap uses the maximum number of colors corresponding to the value of the <c>Win32InfoHeaderV5.BitsPerPixel</c>
        /// member for the compression mode specified by <c>Win32InfoHeaderV5.Compression</c>.
        /// </para>
        /// <para>
        /// If is nonzero and the <c>Win32InfoHeaderV5.BitsPerPixel</c> member is less than 16, the <c>Win32InfoHeaderV5.PaletteSize</c> member
        /// specifies the actual number of colors the graphics engine or device driver accesses.
        /// </para>
        /// <para>
        /// If <c>Win32InfoHeaderV5.BitsPerPixel</c> is 16 or greater, the <c>Win32InfoHeaderV5.PaletteSize</c> member specifies the size of the
        /// color table used to optimize performance of the system color palettes.
        /// </para>
        /// <para>
        /// When the bitmap array immediately follows the <c>Win32InfoHeaderV5</c> structure, it is a packed bitmap.
        /// Packed bitmaps are referenced by a single pointer.
        /// Packed bitmaps require that the <c>Win32InfoHeaderV5.PaletteSize</c> member must be either 0 or the actual size of the color table.
        /// </para>
        ...
        /// <summary>
        /// Color mask that specifies the red component of each pixel, valid only if <c>Win32InfoHeaderV5.Compression</c> is set to
        /// <see cref="BmpCompression.BitFields"/> or <see cref="BmpCompression.AlphaBitFields"/>.
        /// </summary>
        public uint RedMask;

        /// <summary>
        /// Color mask that specifies the green component of each pixel, valid only if <c>Win32InfoHeaderV5.Compression</c> is set to
        /// <see cref="BmpCompression.BitFields"/> or <see cref="BmpCompression.AlphaBitFields"/>.
        /// </summary>
        public uint GreenMask;

        /// <summary>
        /// Color mask that specifies the blue component of each pixel, valid only if <c>Win32InfoHeaderV5.Compression</c> is set to
        /// <see cref="BmpCompression.BitFields"/> or <see cref="BmpCompression.AlphaBitFields"/>.
        /// </summary>
        public uint BlueMask;

        /// <summary>
        /// Color mask that specifies the alpha (transparency) component of each pixel, valid only if <c>Win32InfoHeaderV5.Compression</c> is set to
        /// <see cref="BmpCompression.BitFields"/> or <see cref="BmpCompression.AlphaBitFields"/>.
        /// </summary>
