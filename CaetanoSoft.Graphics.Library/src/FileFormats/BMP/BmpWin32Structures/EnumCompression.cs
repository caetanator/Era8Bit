...
namespace CaetanoSoft.Graphics.FileFormats.BMP.Win32Structures
{
    ...
    internal enum EnumCompression : uint
    {
        ...
        /// <para>Implemented on Microsoft Windows BMP v3 for Windows NT 4 and Microsoft Windows BMP v4.</para>
        /// </summary>
        BitFields = 3,

        /// <summary>
        /// Compressed format using Huffman 1D. Only for 1 bpp bitmaps.
        /// <para>
        ...
        /// </para>
        /// <para>Supported by Windows 98/Windows 2000 and later. Only for printers.</para>
