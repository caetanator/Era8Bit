 ...
 *
 * PURPOSE
 *  This structure represents a Microsoft Windows BMP v2 and IBM OS/2 BMP v1 (and later) file header.
 *  Introduced in Microsoft Windows 2.0 and IBM OS/2 1.0.
 *
 * CONTACTS
...
namespace CaetanoSoft.Graphics.FileFormats.BMP.Win32Structures
{
    ...
    /// </summary>
    /// <remarks>
    /// Make shore that <c>sizeof(Win32FileHeader)</c> returns the size of 12 bytes and is byte aligned.
    /// All structure fields are stored little-endian on the file.
    /// <para>
    /// The DIB information header must follow the <c>Win32FileHeader</c> structure, and consist of one of
    ...
    internal struct Win32FileHeader
    {
        ...
        /// <para><c>    PaletteNumberOfEntries_Present = (Win32FileHeader.PixelsOffset - FileHeaderSize - InfoHeaderSize) / PaletteElementSize</c></para>
        /// </para>
        /// </summary>
        ...
        /// <summary>
        /// Specifies the offset, in bytes, from the beginning of the <c>Win32FileHeader</c> structure to the bitmap pixels color bits/image data.
        /// <para>
