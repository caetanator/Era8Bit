/**
 * EnumBmpNativeStructuresSizes.cs
 *
 * PURPOSE
 *  This enumeration contains all possible Native Structures Sizes for Microsoft Windows and IBM OS/2 bitmaps.
 *
 * CONTACTS
